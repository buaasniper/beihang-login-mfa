...
### 日期
- 周次：第 2 周
- 时间范围：2026-04-09 至 2026-04-25

### ywy：修改前端 
1. 修改前段代码，重点修复鼠标键盘的bug，新增对手机触摸事件的检测
2. 和zy对其一下DeviceId 所需要的signal字段，进行一个补充
3. 新增feature
...
### 日期
- 周次：第 3 周
- 时间范围：2026-04-26 至 2026-04-30

### ywy：修改前端 
1. 修改前段代码，重点修复鼠标键盘的bug，新增对手机触摸事件的检测
2. 和zy对其一下DeviceId所需要的signal字段，进行一个补充
3. 新增feature
4. 版本号更新、出一个md文件对feature的解析

### zzy：
已完成：ua处理效果ok，js改为用python实现
